...
class MarketSchoolRules:
    ...
    def fetch_data(self, start_date: str = None, end_date: str = None):
        ...
        # Calculate indicators (uses the symbol's own raw volume — no proxies)
        self._calculate_indicators()
    ...
    def check_strength_weakness_signals(self, idx: int) -> List[Signal]:
        ...
        # B7: Accumulation Day
        # Rule: gain >= 1.0%, heavier volume (raw ^IXIC or SPY), close in upper
        # 25% of range, close > 21EMA, and CANNOT coincide with B1/B2.
    ...
    def _update_distribution_days(self, idx: int):
        ...
        for dist_day in self.distribution_days:
            ...
            # IBD removes on the 25th trading day (when trading_days_old reaches 25)
