...
# ==============================================================================
    ...
    # --------------------------------------------------------------------------
    # UPDATED TAB LIST (Portfolio Heat added after Risk Manager)
    # --------------------------------------------------------------------------
    tab1, tab2, tab3, tab4, tab5, tab6, tab7, tab_risk, tab_heat, tab8, tab9, tab_cy, tab10, tab_earn, tab11 = st.tabs([
        "Log Buy", 
        "Log Sell", 
        "Update Prices", 
        "Edit Transaction", 
...
# ==========================================================================
    # TAB: EARNINGS PLANNER (Updated: $ EM + Principal Protection)
    # ==========================================================================
    with tab_earn:
