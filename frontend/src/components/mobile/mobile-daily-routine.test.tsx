...
describe("MobileDailyRoutine — mount fetch", () => {
  test("fires all parallel fetches with active portfolio + date", async () => {
    render(<MobileDailyRoutine initialDate="2026-05-25" />);
    await waitFor(() => {
...
describe("MobileDailyRoutine — no journal entry", () => {
...
describe("MobileDailyRoutine — invalid date redirect", () => {
  ...
  test("malformed initialDate fires router.replace('/daily-journal')", async () => {
    render(<MobileDailyRoutine initialDate="not-a-date" />);
    await waitFor(() =>
      expect(replaceMock).toHaveBeenCalledWith("/daily-journal"),
    );
  });
...
describe("MobileDailyRoutine — header meta cycle label", () => {
...
describe("MobileDailyRoutine — header back nav", () => {
...
describe("MobileDailyRoutine — drawdown", () => {
...
describe("MobileDailyRoutine — daily $ delta in metrics tile", () => {
...
describe("MobileDailyRoutine — focus mode hydration", () => {
...
describe("MobileDailyRoutine — Daily Recap preview", () => {
...
describe("MobileDailyRoutine — Daily Thoughts preview", () => {
...
describe("MobileDailyRoutine — Recap edit sheet save flow", () => {
...
describe("MobileDailyRoutine — Performance Comparison", () => {
...
describe("MobileDailyRoutine — Positions Opened", () => {
...
describe("MobileDailyRoutine — Positions Closed", () => {
...
describe("MobileDailyRoutine — Captures + EOD gallery", () => {
...
describe("MobileDailyRoutine — Tags", () => {
...
describe("MobileDailyRoutine — grade tile", () => {
  test.each([
    [5, "A+"],
    [4, "A"],
    [3, "B"],
...
describe("MobileDailyRoutine — DAILY P&L label", () => {
...
describe("MobileDailyRoutine — Market Notes header line", () => {
