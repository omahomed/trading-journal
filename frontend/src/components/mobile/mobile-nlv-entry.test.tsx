...
import { MobileNLVEntry } from "./mobile-nlv-entry";
...
describe("MobileNLVEntry — mount fetch + blank form", () => {
...
describe("MobileNLVEntry — pre-load existing entry", () => {
...
describe("MobileNLVEntry — localStorage autosave", () => {
...
describe("MobileNLVEntry — validation + submit", () => {
