...
import TrendCycleMethodologyClient from "./trend-cycle-methodology-client";

// Same font stack as the M Factor methodology page so both editorial docs
// render with identical typography.
...
export default async function TrendCycleMethodologyPage() {
  await connection();
  return (
    <div className={`contents ${newsreader.variable} ${plexSans.variable} ${plexMono.variable}`}>
      <TrendCycleMethodologyClient />
    </div>
  );
}
